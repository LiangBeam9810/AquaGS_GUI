...
mode_flag_bf = as.integer(args[5])+1#1:A BLUP  2:G GBLUP
print(paste("mode_flag:",mode_flag_bf))
##########################fixed#################################################
j = 6
...
print(paste("mode_flag:",mode_flag))
if(mode_flag == 2)#GBLUP
{
  if(random_num==0)
  {
